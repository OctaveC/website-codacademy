...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { banner_url: @collection.banner_url, name: @collection.name } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { banner_url: @collection.banner_url, name: @collection.name } }
